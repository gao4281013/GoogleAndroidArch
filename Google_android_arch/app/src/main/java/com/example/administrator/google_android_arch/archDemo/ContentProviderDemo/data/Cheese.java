...
public class Cheese {
  ...
  public static Cheese fromContentValues(ContentValues contentValues){
    final Cheese cheese = new Cheese();
    if (contentValues.containsKey(COLUMN_ID)){
      cheese.id = contentValues.getAsLong(COLUMN_ID);
    }
    if (contentValues.containsKey(COLUMN_ID)){
      cheese.name = contentValues.getAsString(COLUMN_NAME);
    }
    return cheese;
  ...
  /** Dummy data. */
  static final String[] CHEESES = {"Stephen Curry",
